<script lang="ts">
	...
	//keep the scroll, will use in sidebar. Starter code at bottom of page
	...
	<section id="waku-objects">
		...
		<DetailSection title="Waku Objects messages" sub section="15">
			<p slot="description">
				...
				according to a standardized layout system. A Waku Object message should always contain a
				link to access that Waku Object full view.
			</p>
		</DetailSection>
		...
		<DetailSection title="Waku Objects full view" sub section="18">
			<p slot="description">
				...
				Each Waku Object full view is different but should follow some usability and layout
	...
	<section id="settings">
		...
		<DetailSection title="Contacts list" sub section="23">
			<p slot="description">
				...
				select a contact and go to the contact page where I can access our private chat or remove it
